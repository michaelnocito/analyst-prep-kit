...
*The full version of this guide lives on my site: [pandas drop_duplicates: keep='first', and the Row It Chose For You](https://michaelnocito.github.io/analyst-prep-kit/guides/pandas-duplicates/).*
