...
![A migration project plan in Excel. Each task has an owner, a status, a start date and a finish date, and the stage ends with a highlighted row reading GATE, scope signed off.](https://michaelnocito.github.io/analyst-prep-kit/guides/migration-scope-creep/plan.png) Every task carries a date and an owner, so a request has somewhere to land. The highlighted row is the gate that closes the stage.
...
![A change request log in Excel. Four requests, each with what was asked for, whether it was in signed scope, the impact on timeline and cost, the decision, and who decided.](https://michaelnocito.github.io/analyst-prep-kit/guides/migration-scope-creep/change-log.png) The same four requests, six weeks later. Nobody has to remember who agreed to what, because the cost and the decision sit next to the request.
...
## References
  ...
  1. Dvir, D., & Lechler, T. (2004). Plans are nothing, changing plans is everything: The impact of changes on project success. _Research Policy, 33_(1), 1–15.
...
*Originally published on Analyst Prep Kit: [Scope Creep and the Project Plan](https://michaelnocito.github.io/analyst-prep-kit/guides/migration-scope-creep/)*
