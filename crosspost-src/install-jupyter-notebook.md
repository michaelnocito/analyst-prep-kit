...
*The full version of this guide lives on my site: [How to Set Up Jupyter Notebook (And Why Your Environment Is Missing From the Kernel List)](https://michaelnocito.github.io/analyst-prep-kit/guides/install-jupyter-notebook/).*
