...
*The full version of this guide lives on my site: [Mean vs Median: When to Use Each, and When the Answer Changes](https://michaelnocito.github.io/analyst-prep-kit/guides/mean-vs-median/).*
