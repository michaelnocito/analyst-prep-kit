...
*The full version of this guide lives on my site: [How to Set Up DuckDB (Run SQL on a CSV With No Import Step)](https://michaelnocito.github.io/analyst-prep-kit/guides/set-up-duckdb/).*
