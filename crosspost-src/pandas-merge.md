...
*Originally published on Analyst Prep Kit: [pandas merge: Left Join, Inner Join, and the One That Doubled the Revenue](https://michaelnocito.github.io/analyst-prep-kit/guides/pandas-merge/)*
