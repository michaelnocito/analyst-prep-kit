...
*Originally published on Analyst Prep Kit: [SUM vs SUMX in DAX: Why a Row-by-Row Calculation Needs an Iterator](https://michaelnocito.github.io/analyst-prep-kit/guides/powerbi-sum-vs-sumx/)*
