...
**Current version:** `v1.31.0` (shipped June 3, 2026 — awaiting test)
**Recent:** v1.31.0 Final Exam **study guide visuals** — a "📺 See it" diagram per subject section (Excel/SQL/Python/Tableau/Stats/Power BI/Interview); first visuals ever in the Final Exam Kit. v1.30.0 cert Cycles 5–7 (Tableau cert-critical subset COMPLETE, 20 lessons). v1.27.0 "Know Your Workspace" UI module. v1.24.0 Cycle 1/7 L14 ✅ PASS.
