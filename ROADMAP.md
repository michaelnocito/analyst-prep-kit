...
**Current version:** `v1.29.0` (shipped June 3, 2026 — awaiting test)
**Recent:** v1.29.0 cert **Cycle 4/7** — new L17 "Sets" (Unit 5, Domain 2.2; IN/OUT introduced light). v1.28.0 Cycle 3/7 L16 Data Properties (Unit 4 mini-unit complete). v1.27.0 "Know Your Workspace" UI module (Tableau/Power BI/Excel). v1.24.0 Cycle 1/7 L14 ✅ PASS.
**Note:** cert beef-up remaining = Tableau Cycles 5–7: **L18 Hierarchies, L19 Parameters, L20 Dual-Axis** (`TABLEAU_CERT_PLAN.md`). Also pending: roll Workspace module to SQL/Python/Stats? (TBD). Parking Lot: deeper IN/OUT-in-filters explainer (fold into L17 Sets when promoted).
