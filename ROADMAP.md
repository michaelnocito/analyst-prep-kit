...
**Current version:** `v1.28.0` (shipped June 3, 2026 — awaiting test)
**Recent:** v1.28.0 cert **Cycle 3/7** — new L16 "Managing Data Properties" (Unit 4, Domain 1.3) — completes the Connecting & Preparing Data mini-unit. v1.27.0 "Know Your Workspace" UI module (Tableau/Power BI/Excel). v1.26.0 cert Cycle 2/7 L15 Joins/Unions/Relationships. v1.24.0 cert Cycle 1/7 L14 ✅ PASS.
**Note:** cert beef-up remaining = Tableau Cycles 4–7: **L17 Sets, L18 Hierarchies, L19 Parameters, L20 Dual-Axis** (`TABLEAU_CERT_PLAN.md`). Also pending: roll Workspace module to SQL/Python/Stats? (TBD — language kits, less GUI.)
