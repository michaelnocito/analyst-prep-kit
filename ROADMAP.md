...
**Current version:** `v1.22.0` (shipped June 3, 2026 — awaiting test)
**Recent:** v1.21.0 Tableau drills → tap-the-choice; v1.22.0 rolled tap-the-choice to all kits' Bug Hunt + Describe drills (no free-text answer boxes remain anywhere). v1.20.1 lesson-complete scroll fix.
