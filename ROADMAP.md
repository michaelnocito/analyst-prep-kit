...
**Current version:** `v1.30.0` (shipped June 3, 2026 — awaiting test)
**Recent:** v1.30.0 cert **Cycles 5–7/7** — L18 Hierarchies, L19 Parameters, L20 Dual-Axis (Chart.js second axis added). **Cert-critical subset COMPLETE** — Tableau now 20 lessons. v1.27.0 "Know Your Workspace" UI module. v1.24.0 Cycle 1/7 L14 ✅ PASS.
