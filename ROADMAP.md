...
**Current version:** `v1.110.0` (shipped July 6, 2026 — 📊 **Medium #6 slices 2+3: Python + Power BI track-lesson charts — the track-chart pull-forward is COMPLETE across all applicable kits** (Tableau/Stats already draw Chart.js viz). 121 headless checks green. Test batch 33 in `apk_CLAUDE.md`. Remaining #6 scope = the broader all-exercise chart/pivot audit (parked flavor); #7 SEO stays post-GSC.)
