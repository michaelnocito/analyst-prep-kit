...
BATCH = {
 "moving-averages": ("forecasting",
   "The line is jumpy, so somebody smoothed it, and now the spike nobody wanted to see is gone.",
   "moving averages and seasonality, including what a window length quietly does to the story"),
 "choose-the-right-chart": ("charts",
 ...
 "how-charts-mislead": ("charts",
   "Every number on the chart is true and the picture still says something false.",
   "the axis, the baseline and the ordering, with the misleading version shown next to the honest one"),
 "choose-your-analyst-role": ("thinking",
   "The job titles all sound the same and the work behind them is not the same work.",
   "what an analyst actually does day to day, so a title stops being the thing you are choosing by"),
}
